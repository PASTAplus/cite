...
class Eml(object):
    ...
    def _get_geographic_coverage(self):
        ...
        if _ is not None:
            ...
            gc["west"] = clean(
                _.find(".//boundingCoordinates/westBoundingCoordinate").text
            )
            gc["east"] = clean(
                _.find(".//boundingCoordinates/eastBoundingCoordinate").text
            )
            gc["north"] = clean(
                _.find(".//boundingCoordinates/northBoundingCoordinate").text
            )
            gc["south"] = clean(
                _.find(".//boundingCoordinates/southBoundingCoordinate").text
            )
        return gc
